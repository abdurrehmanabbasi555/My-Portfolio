    ...
    >
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        />
          ...
          <div className="flex sm:flex-0 items-center justify-between sm:items-stretch">
        ...
        <div className="space-y-1 px-2 pt-2 pb-3">
          {navigation.map((item) => (
            <DisclosureButton
              ...
              aria-current={item.current ? 'page' : undefined}
              className={classNames(
                item.current ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-[#01ce90] hover:underline',
